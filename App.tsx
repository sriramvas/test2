...
const App: React.FC = () => {
  return (
    <div className="min-h-screen w-full bg-[#08070E] text-white overflow-x-hidden font-sans selection:bg-archer-orange selection:text-black">
      
      {/* Global Background Effects */}
      <div className="fixed inset-0 pointer-events-none">
         <div className="absolute top-[-10%] left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-[radial-gradient(circle,rgba(255,107,53,0.05)_0%,transparent_70%)] blur-[100px]"></div>
      </div>
      ...
      <nav className="max-w-[1400px] mx-auto px-6 py-8 flex justify-between items-center relative z-50">
        ...
        <button className="hidden md:block text-sm md:text-base font-bold tracking-wide border border-[#222] bg-[#0A0A0A] text-gray-200 px-8 py-3 rounded-full hover:bg-[#111] hover:text-white hover:border-gray-500">
          Use App
        </button>
      </nav>
      ...
      <section className="relative pt-12 pb-12 md:pt-32 md:pb-24 text-center z-10 max-w-[90%] xl:max-w-7xl mx-auto px-4">
        ...
        {/* Hero & Dashboard Unified Glow */}
        <div className="absolute top-[60%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[180%] md:w-[120%] h-[800px] md:h-[1200px] bg-[radial-gradient(ellipse_at_center,rgba(255,107,53,0.15)_0%,rgba(255,107,53,0.01)_50%,transparent_70%)] blur-[80px] md:blur-[120px] -z-10 pointer-events-none"></div>

        <div>
          <h1 className="text-[37px] sm:text-6xl md:text-7xl lg:text-8xl font-semibold tracking-tight mb-6 md:mb-8 leading-[1.1] md:leading-[0.95] text-white max-w-6xl mx-auto">
            Trade fair. <br/>
        ...
        <div>
          <a 
            href="https://tally.so/r/XxxNQV"
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-block bg-[#FF7834] text-black px-8 py-3 md:px-10 md:py-4 rounded-full font-bold text-base md:text-lg hover:brightness-110 hover:shadow-[0_0_30px_rgba(255,120,52,0.3)]"
          >
            Join Waitlist
          </a>
        </div>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-20 items-center">
            ...
            <div className="relative group flex justify-center md:justify-start">
               <div className="absolute inset-0 bg-archer-orange/5 blur-[60px] rounded-full opacity-50"></div>
               <MarketMakerVisual />
            </div>
            {/* Text Right */}
      ...
      {/* Footer Area */}
      <footer className="mt-10 md:mt-20 w-full bg-[#08070E]">
            ...
            <div className="max-w-7xl mx-auto px-8 py-16 flex flex-col md:flex-row justify-between items-start">
               ...
               <div className="flex flex-col gap-6 text-sm text-gray-400 text-left md:text-right min-w-[150px]">
                 ...
                 <div className="flex flex-col gap-3">
                    <a href="https://x.com/ArcherExchange_" target="_blank" rel="noopener noreferrer" className="hover:text-archer-orange">Twitter (X)</a>
                    <a href="https://x.com/mmdhrumil/status/1983161517617926514?s=20" target="_blank" rel="noopener noreferrer" className="hover:text-archer-orange">Blog</a>
                    <a href="#" className="hover:text-archer-orange">Contact Us</a>
                 </div>
               </div>
            </div>
          </div>
